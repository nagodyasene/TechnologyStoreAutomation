...
public class LeaveRepository : ILeaveRepository
{
    ...
    private class LeaveRequestDto
    {
        ...
        public LeaveRequest ToLeaveRequest() => new()
        {
            ...
            LeaveType = Enum.TryParse<LeaveType>(LeaveType, true, out var lt) ? lt : Features.Leave.LeaveType.Annual,
            StartDate = StartDate,
            EndDate = EndDate,
            TotalDays = TotalDays,
            Reason = Reason,
            Status = Enum.TryParse<LeaveStatus>(Status, true, out var ls) ? ls : Features.Leave.LeaveStatus.Pending,
